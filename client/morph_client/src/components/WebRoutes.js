...
const WebRoutes = () => {
  ...
  return (
       ...
       <Routes>
        ...
        <Route path='/provider' element={<Provider appointmentData= {providerAppointmentData} singleAppointmentData={singleAppointmentData} setAppointmentId={handleSetAppointment}/>} />
