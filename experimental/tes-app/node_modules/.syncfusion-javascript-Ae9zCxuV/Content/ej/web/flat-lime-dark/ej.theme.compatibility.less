...
/*------------------------------------- Button -------------------------------------------*/
.e-widget .e-btn:not(.e-inputbtn), .e-widget .e-tbtn, .e-widget .e-split-btn {
    & when (@skin="material") {
        font-family: @font-family;
        position: relative;
...
.e-widget.e-uploadbox .e-ul li:nth-child(even) .e-file-list, .e-widget.e-uploadbox .e-head-content {
...
.e-js.e-pivotschemadesigner .e-editorTreeView.e-treeViewUl ul, .e-js.e-pivotgrid .e-editorTreeView.e-treeViewUl ul {
  padding-left: 0px !important;
}

.e-js.e-pivotschemadesigner .e-editorTreeView.e-treeViewUl li, .e-js.e-pivotgrid .e-editorTreeView.e-treeViewUl li {
  padding-left: 16px !important;
}
...
.e-widget.ej1-combobox .e-dropdownbase.e-content {
 ...
 .e-widget.ej1-combobox.e-ddl.e-input-group .e-input-group-btn button {
  ...
  .e-widget.ej1-combobox.e-input-group:not(.e-float-icon-left):not(.e-float-input)::after
  .e-widget.ej1-combobox.e-input-group:not(.e-float-icon-left):not(.e-float-input)::before,
  .e-widget.ej1-combobox.e-input-group::before,
  .e-widget.ej1-combobox.e-input-group::after {
    & when not(@skin= "material") {
      background: none;
